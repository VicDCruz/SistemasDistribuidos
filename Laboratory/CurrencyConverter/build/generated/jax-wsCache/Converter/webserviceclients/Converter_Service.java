 ...
 * 
 */
@WebServiceClient(name = "Converter", targetNamespace = "http://webservices/", wsdlLocation = "http://localhost:8080/Converter/Converter?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CONVERTER_QNAME = new QName("http://webservices/", "Converter");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Converter/Converter?WSDL");
    ...
    public Converter getConverterPort() {
        return super.getPort(new QName("http://webservices/", "ConverterPort"), Converter.class);
    }
    ...
    public Converter getConverterPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices/", "ConverterPort"), Converter.class, features);
    }
